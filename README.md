...
Rather than dying when you reach the screen edge, you will instead be wrapped around to the appropriate opposing edge. This allows for some interesting gameplay scenarios.
